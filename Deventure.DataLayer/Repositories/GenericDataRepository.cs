...
using Deventure.DataLayer.Extensions;
...
namespace Deventure.DataLayer.Repositories
{
        ...
        where T : class, IDataAccessObject, new()
    {
        ...
        public override sealed IContext Context
        {
        ...
        protected T Change(T item)
        {
            ...
            Context.SetState<T>(item, (int)EntityState.Modified);
        ...
        {
            Context.SetAutoDetectChanges(false);
            ...
            Context.SetAutoDetectChanges(true);
        ...
        protected void Remove(T item)
        {
            ...
            if (Context.GetState(item) == (int)EntityState.Detached)
            {
                mDbSet.Attach(item);
            }
        ...
        protected void Remove(IList<T> items)
        {
            ...
            foreach (var item in items.Where(item => Context.GetState(item) == (int)EntityState.Detached))
            {
                mDbSet.Attach(item);
            }
